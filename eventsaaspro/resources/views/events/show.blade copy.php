            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-8 col-lg-8 col-md-12 col-12">
                                ...
                                <p class="fs-6 mb-2">
                                    @if (!empty($event['online_location']))
                                        <span class="badge bg-info text-white"><i class="fas fa-signal"></i>&nbsp;
                                            @lang('eventsaaspro-pro::em.online_event')</span>
                                    @endif

                                    <span class="badge bg-primary text-white">{{ $category['name'] }}</span>

                                    @if (!empty($free_tickets))
                                        <span class="badge bg-primary text-white">@lang('eventsaaspro-pro::em.free_tickets')</span>
                                    @endif

                                    @if ($event->repetitive)
                                        @if ($event->repetitive_type == 1)
                                            <span class="badge bg-primary text-white">@lang('eventsaaspro-pro::em.repetitive_daily_event')</span>
                                        @elseif($event->repetitive_type == 2)
                                            <span class="badge bg-primary text-white">@lang('eventsaaspro-pro::em.repetitive_weekly_event')</span>
                                        @elseif($event->repetitive_type == 3)
                                            <span class="badge bg-primary text-white">@lang('eventsaaspro-pro::em.repetitive_monthly_event')</span>
                                        @endif
                                    @endif

                                    @if ($ended)
                                        <span class="badge bg-danger text-white">@lang('eventsaaspro-pro::em.event_ended')</span>
                                    @endif
                                </p>
                            </div>
                            <div class="card-footer bg-gradient">
                                <div class="text-white">
                                    <span><strong>@lang('eventsaaspro-pro::em.share_event') &nbsp;</strong></span>
                            ...
                            <div class="card-body p-4">
                                <div class="mb-4 text-left">
                                    ...
                                    <h4 class="mb-0 fw-bold h4">
                                        @lang('eventsaaspro-pro::em.get_tickets') &nbsp;
                                        <div class="badge bg-primary position-relative">
                                            @lang('eventsaaspro-pro::em.seasonal_tickets')
                                    ...
                                    <p class="text-primary"> @lang('eventsaaspro-pro::em.seasonal_tickets_ie')</p>
                                    @else
                                    <h4 class="mb-0 fw-bold h4">@lang('eventsaaspro-pro::em.get_tickets')</h4>
                                    @endif
                                </div>
                                <div class="row">
                        ...
                        <div class="card mb-4">
                            <div class="card-body p-4">
                                <h4>@lang('eventsaaspro-pro::em.overview')</h4>
                        ...
                        @if ($event['faq'])
                            <div class="card mb-4">
                                <div class="card-body p-4">
                                    <h4 class=" text-left">@lang('eventsaaspro-pro::em.event_info')</h4>
                                    <p>{!! $event['faq'] !!}</p>
                                </div>
                            </div>
                        @endif
                                    ...
                                    <div class="row">
                                        @foreach ($group as $key1 => $value)
                                            <div class="col-lg-4 col-md-6 col-12 text-center">
                                                ...
                                                @if ($value['is_page'] > 0)
                                                    <a
                                                        href="{{ route('eventsaaspro.events_tags', [$event->slug, str_replace(' ', '-', $value['title'])]) }}">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <h5 class="mb-0">
                                                        @if ($value['is_page'] > 0)
                                                            <a
                                                                href="{{ route('eventsaaspro.events_tags', [$event->slug, str_replace(' ', '-', $value['title'])]) }}">{{ $value['title'] }}</a>
                                                        @elseif($value['website'])
                        ...
                        @if (!empty($event->images))
                            <div class="card mb-4">
                                <div class="card-body p-4 pb-0">
                                    <h4 class="mb-3">@lang('eventsaaspro-pro::em.event_gallery')</h4>
                        ...
                        @if (!empty($event->video_link))
                            <div class="card mb-4">
                                <div class="card-body p-4">
                                    <h4 class="mb-3">@lang('eventsaaspro-pro::em.watch_trailer')</h4>
                                    <iframe src="https://www.youtube.com/embed/{{ $event->video_link }}" allowfullscreen
                        ...
                        @if ($event->latitude && $event->longitude)
                            <div class="card mb-4">
                                <div class="card-body">
                                    <h4 class="mb-3">@lang('eventsaaspro-pro::em.location')</h4>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-12">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <!-- card-->
                                <h4 class="mb-2 fw-bold">@lang('eventsaaspro-pro::em.where')</h4>
                                <p>
                                    @if (!empty($event['online_location']))
                                        <strong>@lang('eventsaaspro-pro::em.online_event')</strong> <br>
                                    @endif

                                    @if ($event->venues->isNotEmpty())
                                        <a class="col-white"
                                            href="{{ route('eventsaaspro.venues.show', [$event->venues[0]->slug]) }}"><strong>{{ $event->venue }}
                        ...
                        <div class="card  mb-4">
                            <div class="card-body">
                                <h4 class="mb-2 fw-bold">@lang('eventsaaspro-pro::em.when')</h4>
