...
@section('title')
    @lang('eventsaaspro-pro::em.register')
@endsection
...
@section('authcontent')
    ...
    <div class="card border-0 shadow">
        ...
        <div class="card-body p-5">
            ...
            <h3 class="mb-4">@lang('eventsaaspro-pro::em.register')</h3>
            <!-- form -->
            <form method="POST" action="{{ route('eventsaaspro.register') }}">
                @csrf
                @honeypot
                <div class="mb-3">
                    <label for="email" class="form-label">@lang('eventsaaspro-pro::em.name')</label>
                    <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                        name="name" value="{{ old('name') }}" required autofocus placeholder="@lang('eventsaaspro-pro::em.name')">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input id="email" type="email"
                        ...
                        value="{{ old('email') }}" required placeholder="@lang('eventsaaspro-pro::em.email')">
                ...
                <div class="mb-3">
                    ...
                    <input id="password" type="password"
                        ...
                        placeholder="@lang('eventsaaspro-pro::em.password')">
                ...
                <div class="mb-2">
                    <input class="form-check-input" type="checkbox" name="accept" id="accept" checked value="1"
                        hidden>
                    <p class="text-sm">
                        @lang('eventsaaspro-pro::em.accept_terms')
                    </p>
                </div>
                <!-- button -->

                <button type="submit" class="btn btn-primary btn-block"><i class="fas fa-door-open"></i>
                    @lang('eventsaaspro-pro::em.register')</button>
                ...
                <div class="d-flex justify-content-between mb-2 pb-2 mt-3 text-sm ">
                    ...
                    <!-- forgot password -->
                    <div class="fw-bold">
                        <a href="{{ route('eventsaaspro.login') }}" class="text-inherit"> @lang('eventsaaspro-pro::em.login')</a>
                    </div>
                </div>
                <div class="mt-3">
