...
{{-- Page title --}}
@section('title')
    @lang('eventsaaspro-pro::em.scan_ticket')
@endsection
               ...
               <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card border-0 shadow-sm">
                            <h1 class="fw-bold h2 pt-3 ps-3"> @lang('eventsaaspro-pro::em.scan_ticket')</h1>
                            <ticket-scan
                            ...
                            <form id="form" action="{{ route('eventsaaspro.verify_ticket') }}" method="POST"
                                ...
                                <div class="d-grid">
                                    <button type="submit" id="check_in_button" class="btn btn-success btn-lg"
                                        style="display: none;">@lang('eventsaaspro-pro::em.verify_n_checkin')</button>
                                </div>
                            </form>
                        </div>
                    </div>
