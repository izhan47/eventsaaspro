                        ...
                        <table>
                            <tr>
                                <td style="padding-top: 10px;text-align: center;" class="text-center">
                                    <img src="{{ config('filesystems.disks.s3.url').'logos/Logo-black.png' }}" style="width: 64px;">
                                    <p class="m-heading">
            ...
            <table>
                ...
                <tr>
                    <td style="text-align: center;padding-top: 5px;">
                        ...
                        <img src="{{ "data:image/png;base64,".base64_encode(Storage::disk('s3')->get('qrcodes/' . $qrcode)) }}" style="width: 50%;">
                    </td>
                </tr>
            </table>
        </div>
                            ...
                            <table>
                                <tr>
                                    <td class="row-divide">
                                        ...
                                        <p class="label">@lang('eventsaaspro-pro::em.venue')</p>
                                    ...
                                    <td class="row-divide">
                                        ...
                                        <img style="width: 80%; border-radius: 12px; float: right; margin-top: 5px;" src="{{ $event->poster }}">
                                    </td>
                                </tr>
                            </table>
                        </div>
