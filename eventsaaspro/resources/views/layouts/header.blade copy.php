                ...
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                        <ul class="navbar-nav mx-lg-auto">
                            ...
                            @guest
                                @include('eventsaaspro::layouts.guest_header')
                            @else
                                @include('eventsaaspro::layouts.member_header')
                            @endguest

                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('eventsaaspro.venues.index') }}"><i
                                        class="fas fa-map-location"></i> @lang('eventsaaspro-pro::em.venues')</a>
                            </li>
                            ...
                            @if (!empty($categoriesMenu))
                                ...
                                <li class="nav-item dropdown ">
                                    <a class="nav-link dropdown-toggle" href="#" id="homeDropdown" role="button"
                                        ...
                                        @lang('eventsaaspro-pro::em.categories')&nbsp;<i class="fas fa-caret-down"></i>
                                    </a>
                                    <ul class="dropdown-menu">
                                        @foreach ($categoriesMenu as $val)
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('eventsaaspro.events_index', ['category' => urlencode($val->name)]) }}">
                                                    {{ $val->name }}
                                                </a>
                            ...
                            @if (!empty($headerMenuItems))
                                <li class="nav-item dropdown ">
                                    <a id="navbarDropdown" class="nav-link dropdown-toggle nav-item dropdown"
                                        ...
                                        @lang('eventsaaspro-pro::em.more') &nbsp;<i class="fas fa-caret-down"></i>
                                    </a>
                        ...
                        <a href="{{ route('eventsaaspro.events_index') }}"
                            class="btn btn-primary d-none d-lg-block bg-gradient">
                            <i class="fas fa-calendar-day"></i> @lang('eventsaaspro-pro::em.browse_events')
                        </a>
                    </div>
                </nav>
            </div>
