...
@section('title')
    @lang('eventsaaspro-pro::em.profile')
@endsection
                    ...
                    <ul class="nav nav-lb-tab text-center w-space">
                        <li class="nav-item">
                            <router-link class="nav-link" :to="{ name: 'personal-details' }">
                                @lang('eventsaaspro-pro::em.personal_details')
                        ...
                        <li class="nav-item">
                            <router-link class="nav-link" :to="{ name: 'security' }">
                                @lang('eventsaaspro-pro::em.security')
                        ...
                        <li class="nav-item">
                            <router-link class="nav-link" :to="{ name: 'bank-details' }">
                                @lang('eventsaaspro-pro::em.update_bank_details')
                        ...
                        @if ((Auth::user()->hasRole('customer') &&  !empty($user->organisation)) || Auth::user()->hasRole('organiser'))


                            <li class="nav-item" >
                                <router-link class="nav-link" :to="{ name: 'organiser-info' }">
                                    @lang('eventsaaspro-pro::em.organiser_info')
                        ...
                        @if (Auth::user()->hasRole('customer'))
                            ...
                            @if ((int)setting('multi-vendor.multi_vendor'))
                                ...
                                @if (
                                    (setting('multi-vendor.manually_approve_organizer') && empty($user->organisation)) )
                                    <li class="nav-item">
                                        <router-link class="nav-link" :to="{ name: 'become-organiser' }">
                                            @lang('eventsaaspro-pro::em.become_organiser')
                        ...
                        <li class="nav-item">
                            <router-link class="nav-link" :to="{ name: 'additional_information' }">
                                @lang('eventsaaspro-pro::em.more_event_info')
                                <i class="fas fa-check-circle text-primary"></i>
                            </router-link>
                        </li>
                    </ul>
