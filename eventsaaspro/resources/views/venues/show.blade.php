    ...
    <div class="container mt-4">
        <div class="row mb-5">
            <div class="col-xl-8 col-lg-8 col-md-12 col-12">
                ...
                <div class="card mb-4">
                    <div class="card-body p-4">
                        <h4>@lang('eventsaaspro-pro::em.pricing')</h4>
                ...
                <div class="card mb-4">
                    <div class="card-body p-4">
                        <h4>@lang('eventsaaspro-pro::em.availability')</h4>
                ...
                <div class="card mb-4">
                    <div class="card-body p-4">
                        <h4>@lang('eventsaaspro-pro::em.food')</h4>
                        <div>{!! $venue->food !!}</div>
                    </div>
                </div>
                @endif
                ...
                <div class="card mb-4">
                    <div class="card-body p-4">
                        <h4>@lang('eventsaaspro-pro::em.amenities')</h4>
                ...
                <div class="card my-5" id="gallery">
                    <div class="card-body p-4">
                        <h4 class="mb-4">@lang('eventsaaspro-pro::em.gallery')</h4>
                ...
                <div class="card mb-4">
                    <div class="card-body p-4">
                        <h4 class="mb-1">@lang('eventsaaspro-pro::em.location')</h4>
            ...
            <div class="col-xl-4 col-lg-4 col-md-12 col-12 ">
                ...
                <div class="card mb-4">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center">
                            <div>
                                <h4 class="mb-1">@lang('eventsaaspro-pro::em.seated') / @lang('eventsaaspro-pro::em.standing')</h4>
                                <p class="mb-0">
                ...
                <div class="card mb-4">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center">
                            <div>
                                <h4 class="mb-1">@lang('eventsaaspro-pro::em.neighborhoods')</h4>
                                <p class="mb-0">
                                    {{ $venue->neighborhoods }}
                                </p>
                            </div>
                ...
                <div class="card mb-4">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center">
                            <div>
                                <h4 class="mb-1">@lang('eventsaaspro-pro::em.address')</h4>
                                <p class="mb-0">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-4">
                            <div class="card-body p-4">
                                <h5 class="card-title">@lang('eventsaaspro-pro::em.request_a_quote')</h5>
                                @if (\Session::has('msg'))
                                ...
                                <form method="POST" class="lgx-contactform"
                                    action="{{ route('eventsaaspro.request_quote') }}">
                                    @csrf
                                    @honeypot
                                    ...
                                    <div class="form-group mb-3">
                                        <input type="text" name="name" class="form-control" id="lgxname"
                                            placeholder="{{ __('eventsaaspro-pro::em.name') }}" required=""
                                            aria-required="true">
                                    </div>
                                    <div class="form-group mb-3">
                                        <input type="email" name="email" class="form-control" id="lgxemail"
                                            placeholder="{{ __('eventsaaspro-pro::em.email') }}" required=""
                                            aria-required="true">
                                    </div>
                                    <div class="form-group mb-3">
                                        <input type="text" name="phone" class="form-control" id="phone"
                                            placeholder="{{ __('eventsaaspro-pro::em.phone') }}" required=""
                                            aria-required="true">
                                    </div>
                                    <div class="form-group mb-3">
                                        <input type="text" name="guests" class="form-control lgxsubject"
                                            id="lgxsubject" placeholder="{{ __('eventsaaspro-pro::em.number_of_guests') }}"
                                            aria-required="true">
                                    </div>
                                    <div class="form-group mb-3">
                                        <textarea class="form-control lgxmessage" name="message" id="lgxmessage" rows="5"
                                            placeholder="{{ __('eventsaaspro-pro::em.mention_query') }}" required="" aria-required="true"></textarea>
                                    </div>
                                    <button type="submit" name="submit" value="contact-form"
                                        class="btn btn-primary"><span>@lang('eventsaaspro-pro::em.send_message')</span></button>
                                </form>
                            </div>
                        </div>
                    </div>
