                                ...
                                <tbody>
                                    @if(!empty($commissions))
                                        @foreach($commissions as $key => $data)
                                            <form method="POST"  action="{{route('eventsaaspro.commission_update')}}" class="form-search">
                                                {{ csrf_field() }}
                                                <tr>
                                                ...
                                                <input type="hidden" class="form-control" name="event_id" value="{{$data->event_id}}">
                                                    ...
                                                    <td>{{ setting('regional.currency_default') }} {{ $data->customer_paid_total}}</td>
                                                    <td>{{ setting('regional.currency_default') }} {{ $data->admin_commission_total }}</td>
                                                    <td>{{ setting('regional.currency_default') }} {{ $data->admin_tax_total }}</td>
                                                    <td>{{ setting('regional.currency_default') }} {{ $data->comedian_total_commission }}</td>
                                                    <td>{{ setting('regional.currency_default') }} {{ $data->organiser_earning_total - $data->comedian_total_commission  }}</td>
                                ...
                                <tbody>
                                    @if(!empty($refunds))
                                        @foreach($refunds as $key => $data)
                                            <form method="POST"  action="{{route('eventsaaspro.settlement_update')}}" class="form-search">
                                                {{ csrf_field() }}
                                                <tr>
                                                <input type="hidden" class="form-control" name="month_year"  value="{{$data->month_year}}">
                                                <input type="hidden" class="form-control" name="organiser_id" value="{{$data->org_id}}">
                                                <input type="hidden" class="form-control" name="event_id" value="{{$data->event_id}}">
                                                    ...
                                                    <td>{{ setting('regional.currency_default') }} {{ $data->admin_commission_total }}</td>
                                                    <td>{{ setting('regional.currency_default') }} {{ $data->admin_tax_total }}</td>
                                                    <td>{{ setting('regional.currency_default') }} -{{ $data->organiser_earning_total }}</td>
                                                    <td>{{ $data->month_year}}</td>
                                                    <td>
                                                        <div class="form-check">
