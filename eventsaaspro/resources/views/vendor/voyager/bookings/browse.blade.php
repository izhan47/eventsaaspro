                            ...
                            <table id="dataTable" class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        @endforeach
                                        <th> {{ __('eventsaaspro-pro::em.expired') }} </th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            <a href="{{ route('eventsaaspro.obookings_organiser_bookings_show',[$data->id])}}" class="btn btn-sm btn-warning view pull-right">
                                                <i class="voyager-eye"></i> <span class="hidden-xs hidden-sm">{{ __('voyager::generic.view') }}</span>
                                            </a>

                                            <a href="{{ route('eventsaaspro.downloads_index',[$data->id, $data->order_number])}}" class="btn btn-sm btn-success download pull-right">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <form action="{{ route('eventsaaspro.obookings_organiser_booking_delete',[$data->id]) }}" id="delete_form" method="GET">
                                                                {{ csrf_field() }}
...
@section('javascript')
    ...
    <script>
        ...
        function send_email(){
            ...
            var send_email_route = {!! json_encode(route('eventsaaspro.send_email'), JSON_HEX_TAG) !!};

            if(is_success <= 0)
                return false;

            var msg = "@lang('eventsaaspro-pro::em.booking_success')<br> @lang('eventsaaspro-pro::em.booking_mail')";
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(data.status > 0){
                        Swal.close();
                        var msg = "<p>@lang('eventsaaspro-pro::em.booking_success')</p>"+
                                "<p>@lang('eventsaaspro-pro::em.booking_email_sent')</p>";
