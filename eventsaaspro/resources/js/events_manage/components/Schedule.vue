<template>
    <div class="schedule-row mb-3">
        ...
        <div class="row">
            ...
            <div class="col-12" v-if="sch_r_type === 3">
               <div v-for="(item, index) in repetitive_dates" :key="index">
    ...
    methods: {
        ...
        updateSchedule() {
            ...
            if(this.repetitive_dates != null && Object.keys(this.repetitive_dates).length > 0)
            {
                ...
                tmp_repetitive_dates = this.repetitive_dates
            ...
            let formatted_from = this.from.map(item => moment(item).locale('en').format('HH:mm:ss'));
            let formatted_to = this.to.map(item2 => moment(item2).locale('en').format('HH:mm:ss'));
