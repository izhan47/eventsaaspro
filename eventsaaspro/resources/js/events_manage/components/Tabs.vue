<template>
    <div>
        ...
        <ul class="nav nav-lb-tab text-center w-space">
            ...
            <li class="nav-item">
                <router-link :to="{ name: 'comedians' }" class="nav-link">
                    Comedians
                    <i class="fas fa-exclamation-circle text-danger" v-if="!is_publishable.comedians"></i>
                    <i class="fas fa-check-circle text-success" v-else></i>
                </router-link>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <router-link :to="{ name: 'coupons' }" id="coupons" class="nav-link">
                    Coupons
                    <i class="fas fa-check-circle text-success"></i>
