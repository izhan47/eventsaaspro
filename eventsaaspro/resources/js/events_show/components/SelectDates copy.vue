...
<template>
    <div v-if="!login_user_id">
        ...
        <div class="card border-0 shadow-sm img-hover lgx-single-schedule expired-event">
                    ...
                    <div class="row" role="tablist" aria-multiselectable="true" v-if="parseInt(schedules[0].repetitive_type) != parseInt(2)">
                        ...
                        <a role="button" data-toggle="collapse" aria-expanded="true" aria-controls="collapseOne">
                            ...
                            >
                                <div class="d-flex justify-content-between flex-wrap card-body schedule-info"
                                    @click="() => {
                                        eventStartTime = `${userTimezone1(dateToShortDate(selected_date+' '+schedules[index].from_time, schedules[index].from_date), date_format.vue_date_format).format(date_format.vue_date_format)} - ${changeTimeFormat(userTimezone1(moment(schedules[index].from_date).format('YYYY-MM')+'-'+selected_date+' '+schedules[index].from_time, 'YYYY-MM-DD HH:mm:ss').format('HH:mm:ss'))} ${showTimezone()}`;
                                    ...
                                    <span class="badge bg-light text-primary">{{ changeTimeFormat(userTimezone1(moment(schedules[index].from_date).format('YYYY-MM')+'-'+selected_date+' '+schedules[index].from_time, 'YYYY-MM-DD HH:mm:ss').format('HH:mm:ss')) }} -
                    ...
                    <div v-else class="row" role="tablist" aria-multiselectable="true">
                        ...
                        <a role="button" data-toggle="collapse" aria-expanded="true" aria-controls="collapseOne">
                            ...
                            >
                                <div class="d-flex justify-content-between flex-wrap card-body schedule-info"
                                    @click="() => {
                                        eventStartTime = `${userTimezone(dateToShortDate(selected_date+' '+schedules[index].from_time, schedules[index].from_date), date_format.vue_date_format).format(date_format.vue_date_format)} - ${changeTimeFormat(userTimezone(moment(schedules[index].from_date).format('YYYY-MM')+'-'+selected_date+' '+schedules[index].from_time, 'YYYY-MM-DD HH:mm:ss').format('HH:mm:ss'))} ${showTimezone()}`;
                                ...
                                >
                                    ...
                                    <span class="badge bg-light text-primary">{{ changeTimeFormat(userTimezone(moment(schedules[index].from_date).format('YYYY-MM')+'-'+selected_date+' '+schedules[index].from_time, 'YYYY-MM-DD HH:mm:ss').format('HH:mm:ss')) }} -
                    ...
                    <div class="row" role="tablist" aria-multiselectable="true">
                        <a role="button" data-toggle="collapse" aria-expanded="true" aria-controls="collapseOne">
                            <div class="card border-0 shadow-sm img-hover mb-2 lgx-single-schedule"
                                ...
                                @click=" () => {
                                    eventStartTime = `${changeTimeFormat(userTimezone1(moment(schedules[index].from_date).format('YYYY-MM')+'-'+selected_dates[index][0]+' '+schedules[index].from_time, 'YYYY-MM-DD HH:mm:ss').format('HH:mm:ss'))} - ${changeTimeFormat(userTimezone1(moment(schedules[index].to_date).format('YYYY-MM')+'-'+selected_dates[index][0]+' '+schedules[index].to_time, 'YYYY-MM-DD HH:mm:ss').format('HH:mm:ss'))} ${showTimezone()}`
                    ...
                    <div class="row" role="tablist" aria-multiselectable="true">
                        ...
                        <a role="button" data-toggle="collapse" aria-expanded="true" aria-controls="collapseOne">
                            <div class="card border-0 shadow-sm img-hover mb-2 lgx-single-schedule"
                                ...
                                :key="index2"
                                @click="() => {
                                    eventStartTime = `${changeTimeFormat(userTimezone(moment(schedules[index].from_date).format('YYYY-MM')+'-'+selected_dates[index]+' '+schedules[index].from_time, 'YYYY-MM-DD HH:mm:ss').format('HH:mm:ss'))} - ${changeTimeFormat(userTimezone(moment(schedules[index].to_date).format('YYYY-MM')+'-'+selected_dates[index]+' '+schedules[index].to_time, 'YYYY-MM-DD HH:mm:ss').format('HH:mm:ss'))} ${showTimezone()}`
...
export default {
    ...
    methods: {
        ...
        singleEventDateTime () {
            ...
            return `${startDate} - ${startTime} ${this.showTimezone()}`
        },
    },
    mounted() {
        if(this.event.repetitive > 0)
