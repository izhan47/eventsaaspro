            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">
                            <i class="fas fa-sliders-h text-primary"></i> {{ trans('em.filters') }}
                        </h4>
                        ...
                        <div>
                            ...
                            <button type="button" class="btn btn-outline-primary btn-sm" data-bs-toggle="collapse" data-bs-target="#collapseFilters"><i class="fas fa-bars"></i></button>
                        </div>
                    </div>
                </div>
            </div>

            <div class="row collapse mt-3" id="collapseFilters">
                <div class="col-md-3">
            ...
            <div class="row mt-3">
                <div class="col-12">
                    ...
                    <div class="row" v-if="venues.length > 0">
                        <div class="col-12">
                            <pagination-component v-if="pagination.last_page > 1" :pagination="pagination" :offset="pagination.total" :path="'venues'" @paginate="checkEvents()"></pagination-component>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        getVenue() {
            ...
            axios.get(route('eventsaaspro.venues.index')+'?page='+this.current_page+'&category='+encodeURIComponent(this.f_category)+'&search='+this.f_search+'&start_date='
