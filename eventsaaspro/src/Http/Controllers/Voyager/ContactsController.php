...
class ContactsController extends VoyagerBaseController
{
    ...
    public function __construct()
    {
        ...
        {
            return redirect()->route('voyager.contacts.index')->send();
        }
        // ---------------------------------------------------------------------
    }
    ...
    public function index(Request $request)
    {
        ...
        $view = 'eventsaaspro::vendor.voyager.contacts.browse';
    ...
    public function show(Request $request, $id)
    {
        ...
        $view = 'eventsaaspro::vendor.voyager.contacts.read';

        return EventSaaSPro::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'isSoftDeleted'));
    }
}
