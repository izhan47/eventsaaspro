...
class CommissionsController extends VoyagerBaseController
{
    ...
    public function __construct()
    {
        ...
        $enable_routes = ["$route_name.index", "$route_name.destroy", "$route_name.show", "$route_name.update", "$route_name.edit", "eventsaaspro.commission_update", "eventsaaspro.settlement_update"];
    ...
    public function index(Request $request)
    {
        ...
        $view = 'eventsaaspro::vendor.voyager.commissions.browse';
    ...
    public function show(Request $request, $organiser_id = null)
    {
        ...
        $view = 'eventsaaspro::vendor.voyager.commissions.update_commissions';
