...
class VoyagerUserController extends BaseVoyagerUserController
{
    ...
    public function index(Request $request)
    {
        ...
        $view = 'eventsaaspro::vendor.voyager.users.browse';
    ...
    public function edit(Request $request, $id)
    {
        ...
        $view = 'eventsaaspro::vendor.voyager.users.edit-add';

        return EventSaaSPro::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable'));
    }
