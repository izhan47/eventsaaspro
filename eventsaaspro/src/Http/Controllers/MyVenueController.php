...
class MyVenueController extends Controller
{
     ...
     */
    public function index(Request $request, $id = null, $view = 'eventsaaspro::venues.form', $extra = [])
    {
        ...
        return EventSaaSPro::view($view, compact('organiser_id', 'path', 'extra'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasfile('images'))
        {
            ...
            foreach ($files as $key => $file) {
                ...
                $image_resize = Image::make($file)->encode('webp', 90)->resize(1280, 720);
