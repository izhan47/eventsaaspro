...
class UpdateCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'eventsaaspro-pro:update';
     ...
     * @var string
     */
    protected $description = 'EventSaaSPro Updater';
    ...
    private function update(Filesystem $filesystem)
    {
        ...
        // 1. Run EventSaaSPro migrations
        $this->info('1. Migrating the EventSaaSPro database tables to update');
        $this->call('migrate', ['--force' => $this->option('force')]);

        // 2. Run database seeder
        $this->info('2. Running EventSaaSPro database update seeders');
        ...
        $this->info('Congrats! EventSaaSPro updated successfully to version '.$version);
    }
