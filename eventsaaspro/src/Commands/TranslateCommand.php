...
class TranslateCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'eventsaaspro-pro:translate-admin-panel';
     ...
     * @var string
     */
    protected $description = 'EventSaaSPro Admin Panel Translator';
    ...
    private function translate(Filesystem $filesystem)
    {
        ...
        // Finish
        $this->info('Congrats! EventSaaSPro Admin Panel translated successfully!');
    }
