...
/**
 * EventSaaSPro asset helpers
 *
 * Make a direct access link to eventsaaspro asset route
 *
*/
if (!function_exists('eventmie_asset'))
{
    ...
    {
        return route('eventsaaspro.eventmie_assets').'?path='.urlencode($path);
    }
}
...
if (!function_exists('eventmie_url'))
{
    ...
    {
        return url(config('eventsaaspro.route.prefix').'/'.$url);
    }
}

/**
 * EventSaaSPro Dateformat carbon
 *
 * dateformat helper
 *
*/
...
/**
 * EventSaaSPro Dateformat Javascript
 *
...
/**
 * EventSaaSPro Timeformat Javascript
 *
...
if (!function_exists('notifications'))
{
    ...
    {
        $user_id        = \Auth::id();
        $user           = \Eventsaaspro\Models\User::find($user_id);
...
if (!function_exists('is_rtl'))
{
    ...
    function is_rtl()
    {
        $rtl_langs = config('eventsaaspro.rtl_langs');
...
/**
 *  get all language folder name from resource/lang/vendor/eventsaaspro
 */
if (!function_exists('lang_selector'))
{
    ...
    function lang_selector()
    {
        ...
        $lang_path = resource_path('lang'.DIRECTORY_SEPARATOR.'vendor'.DIRECTORY_SEPARATOR.'eventsaaspro-pro');
        if(config('voyager.pkg_dev_mode') || config('voyager.demo_mode'))
            $lang_path = dirname(__DIR__).'/../publishable/lang/eventsaaspro-pro';
