...
class DataRowsTableSeeder extends Seeder
{
    ...
    protected function events()
    {
        ...
        "model" => "Eventsaaspro\Models\User",
        "table" => "users",
        "type" => "belongsTo",
        "column" => "user_id",
        "key" => "id",
        ...
        "model" => "Eventsaaspro\Models\Category",
        "table" => "categories",
        "type" => "belongsTo",
        "column" => "category_id",
        "key" => "id",
        ...
        "model" => "Eventsaaspro\Models\Country",
        "table" => "countries",
        "type" => "belongsTo",
        "column" => "country_id",
        "key" => "id",
        ...
        if ($dataRow->exists) {
            $dataRow->fill(["type" => "select_dropdown", "display_name" => "Seasonal Tickets", "required" => 1, "browse" => 1, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        "default" => "1",
        "options" => [
                "1"=>"Yes",
                "0"=>"No",
    ...
    protected function banners()
    {
        ...
        $dataRow = $this->dataRow($DataType, "image");
        if ($dataRow->exists) {
            $dataRow->fill(["type" => "image", "display_name" => "Image", "required" => 1, "browse" => 1, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => "{}", "order" => 4, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "status");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "select_dropdown", "display_name" => "Status", "required" => 0, "browse" => 1, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
    ...
    protected function venues()
    {
        ...
        $dataRow = $this->dataRow($DataType, "organizer_id");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "organiser", "display_name" => "Organizer", "required" => 1, "browse" => 0, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => "{}", "order" => 1, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "id");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Id", "required" => 1, "browse" => 1, "read" => 1, "edit" => 0, "add" => 0, "delete" => 0, "details" => "{}", "order" => 2, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "title");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Title", "required" => 1, "browse" => 1, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        ...
        $dataRow = $this->dataRow($DataType, "venue_type");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Venue Type", "required" => 1, "browse" => 1, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" =>  [
        "validation" => [
                "rule" => "required|max:512"
            ],
        ...
        $dataRow = $this->dataRow($DataType, "amenities");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "rich_text_box", "display_name" => "Amenities", "required" => 0, "browse" => 0, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        "validation" => [
                "rule" => "nullable"
            ],
        ], "order" => 6, ])->save();
        ...
        $dataRow = $this->dataRow($DataType, "seated_guestnumber");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Seated Guestnumber", "required" => 0, "browse" => 0, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        "validation" => [
                "rule" => "nullable"
            ],
        ], "order" => 8, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "standing_guestnumber");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Standing Guestnumber", "required" => 0, "browse" => 0, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        "validation" => [
                "rule" => "nullable"
            ],
        ], "order" => 9, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "neighborhoods");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "rich_text_box", "display_name" => "Neighborhoods", "required" => 0, "browse" => 0, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        "validation" => [
                "rule" => "nullable"
            ],
        ], "order" => 10, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "pricing");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "rich_text_box", "display_name" => "Pricing", "required" => 0, "browse" => 0, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        "validation" => [
                "rule" => "nullable"
            ],
        ], "order" => 11, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "availability");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "rich_text_box", "display_name" => "Availability", "required" => 0, "browse" => 0, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        "validation" => [
                "rule" => "nullable"
            ],
        ], "order" => 12, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "food");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "rich_text_box", "display_name" => "Food", "required" => 0, "browse" => 0, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        "validation" => [
                "rule" => "nullable"
            ],
        ], "order" => 13, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "show_quoteform");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "select_dropdown", "display_name" => "Show Quotation Form", "required" => 1, "browse" => 1, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        "default" => "1",
        "options" => [
                "1"=> "Yes",
                "0"=> "No",
        ...
        $dataRow = $this->dataRow($DataType, "contact_email");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Contact Email", "required" => 0, "browse" => 0, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        "validation" => [
                "rule" => "nullable"
            ],
        ], "order" => 15, ])->save();
        ...
        $dataRow = $this->dataRow($DataType, "country_id");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "country", "display_name" => "Country", "required" => 1, "browse" => 0, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => "{}", "order" => 19, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "zipcode");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Zipcode", "required" => 0, "browse" => 0, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        ...
        $dataRow = $this->dataRow($DataType, "glat");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Google Lattitude", "required" => 0, "browse" => 0, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        "validation" => [
                "rule" => "nullable"
            ],
        ], "order" => 21, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "glong");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "text", "display_name" => "Google Longitude", "required" => 0, "browse" => 0, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => [
        "validation" => [
                "rule" => "nullable"
            ],
        ], "order" => 22, ])->save();
        ...
        $dataRow = $this->dataRow($DataType, "images");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "multiple_images", "display_name" => "Images", "required" => 0, "browse" => 0, "read" => 1, "edit" => 1, "add" => 1, "delete" => 1, "details" => "{}", "order" => 23, ])->save();
        }
        ...
        $dataRow = $this->dataRow($DataType, "created_at");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "timestamp", "display_name" => "Created At", "required" => 0, "browse" => 0, "read" => 1, "edit" => 0, "add" => 0, "delete" => 0, "details" => "{}", "order" => 25, ])->save();
        }
        $dataRow = $this->dataRow($DataType, "updated_at");
        if (!$dataRow->exists) {
            $dataRow->fill(["type" => "timestamp", "display_name" => "Updated At", "required" => 0, "browse" => 1, "read" => 1, "edit" => 0, "add" => 0, "delete" => 0, "details" => "{}", "order" => 26, ])->save();
        }
    }
